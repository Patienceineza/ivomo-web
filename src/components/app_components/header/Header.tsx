...
import { toggleRTL, toggleTheme, toggleSidebar } from '../../../core/redux/store/themeConfigSlice';
...
const Header = () => {
    ...
    const { handleLogout, loadingLogout } = useLogout();
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0">
                            <Link to="/admin/notifications" className='relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'>
                            <span>
                                        <IconBellBing />
