...
export default function CreditorReportSummary() {
    const tabs = [
        {
            icon: UserIcon,
            title: 'Personal',
    ...
    return (
        <div className="text-gray-700 dark:grey-200">
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <Link to="/creditor/reports" className="text-primary before:content-['/'] ltr:before:mr-2 rtl:before:ml-2 hover:underline">
                        Reports
                    </Link>
                </li>
            ...
            <div className="panel mt-5" id="icon">
                <div className="mb-5 flex items-center justify-between">
                    <h5 className="text-lg font-semibold dark:text-gray-300">Creditor Reports</h5>
                </div>
                <div className="mb-5">
                    <Tab.Group>
