...
import { BanknotesIcon, CpuChipIcon, CreditCardIcon, UserIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
export default function ConsumerReports() {
    const tabs = [
        {
            icon: UserIcon,
            title: 'Personal',
        ...
        <div className="text-gray-700 dark:grey-200">
            ...
            <div className="panel mt-5" id="icon">
                <div className="mb-5 flex items-center justify-between">
                    <h5 className="text-lg font-semibold dark:text-gray-300">Credit Reports</h5>
                </div>
                <div className="mb-5">
                    <Tab.Group>
